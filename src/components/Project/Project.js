      ...
      <div className="project-card">
        {/* If page is /illustrations then use class "illos-thumbnail" */}
         <div className="project-image-wrap">
          <img className={thumbnailClass} src={props.thumbnail} alt={props.title} />
          {props.hoverThumbnail && (
            <img className={`${thumbnailClass} hover-thumbnail`} src={props.hoverThumbnail} alt={`${props.title} draft sketch`} />
          )}
         </div>
