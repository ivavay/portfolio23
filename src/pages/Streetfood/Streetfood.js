...
export default function Streetfood(){
    return(
        <div>
            ...
            <div className="bio">
                <p>Last year, I had the chance to join a team of data viz enthusiasts at Taiwan Data Stories to work on a project around Taiwan's night market snacks as a part of the 2022's #30daysofchart challenge on Twitter.
                ...
                See live interactice website <a className="underline" href="https://taiwandatastories.com/taiwan-street-food-interactive/" target="blank">here</a>.
                </p>
            </div>
