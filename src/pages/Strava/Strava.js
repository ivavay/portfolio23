...
export default function Strava() {
    return(
        <div>
            <LazyImage src={stravatn} alt="banner" className="banner"/>
            ...
            <div className="center">
                <LazyImage alt="sketch" src={sketches} className="fullsize-img"/>
            </div>
            <h2 className="title">Iterations based on Feedbacks</h2>
            <div className="center">
                <LazyImage alt="feedback" src={feedback} className="fullsize-img"/>
            </div>
            ...
            <div className="center">
                <LazyImage src={gif} alt="gif" className="midsize-img"/>
            </div>
