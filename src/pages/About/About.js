...
export default function About(){
    return(
        <div>
            ...
            <div className="bio">
                <p>My name is Ivy & I'm a product designer/3D designer based in Taipei, Taiwan. I graduated from the University of California, Santa Cruz in 2021 with a B.S. in Cognitive Science 
